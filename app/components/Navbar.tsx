            ...
            {mobileMenuOpen && (
                <div className="lg:hidden bg-[#1d120a] border-b border-[#5c3a1e] px-6 py-4 flex flex-col gap-3 font-semibold text-xs tracking-wider text-[#d8c8b0] uppercase">
                    ...
                    <a
                        ...
                        className="w-full py-5 rounded-lg font-pirate text-lg text-white font-bold btn-crimson text-center flex items-center justify-center gap-2 cursor-pointer"
                    >
