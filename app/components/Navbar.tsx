...
export default function Navbar({
  ...
  return (
    <header className="fixed top-0 inset-x-0 z-50 w-full wood-nav-bg border-b border-[#5c3a1e] shadow-2xl transition-all backdrop-blur-md">
      ...
      <div className="h-1 w-full bg-gradient-to-r from-[#b8860b] via-[#ffd700] to-[#b8860b] opacity-80" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
        ...
        >
          <div className="w-11 h-11 rounded-full bg-gradient-to-br from-[#d4af37] via-[#8b5a2b] to-[#2b1b17] p-0.5 shadow-lg group-hover:rotate-12 transition-transform duration-300 flex items-center justify-center">
          ...
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                {item.label}
                {isActive && (
                  <span className="absolute bottom-0 left-0 w-full h-[3px] bg-gradient-to-r from-[#d4af37] via-[#a81c19] to-[#d4af37] rounded-full shadow-[0_0_8px_rgba(212,175,55,0.8)]" />
                )}
              </a>
            );
          })}
        ...
        <div className="hidden lg:flex items-center justify-center gap-3">
          <button
            ...
            className="p-2.5 rounded-lg border border-[#8b5a2b]/60 bg-[#2b1b17] text-[#f4ecd8] hover:bg-[#3d271d] hover:border-[#d4af37] transition-all text-xs font-semibold flex items-center gap-1.5 shadow-md"
            title="Toggle Sea Ambience Sound"
          >
          ...
          <button
            ...
            className="px-8 py-3.5 rounded-lg font-pirate text-xl leading-none tracking-wider text-white font-bold shadow-lg hover:scale-105 active:scale-95 transition-transform flex items-center justify-center text-center bg-[url('/images/register.png')] bg-[length:100%_100%] bg-center bg-no-repeat"
          >
        ...
        <div className="lg:hidden flex items-center gap-2">
          <button
            onClick={onToggleSound}
            className="p-2 rounded-lg border border-[#8b5a2b] bg-[#2b1b17] text-[#f4ecd8]"
          >
            {soundEnabled ? "🔊" : "🔇"}
          </button>
          <button
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden bg-[#1d120a] border-b border-[#5c3a1e] px-6 py-4 flex flex-col gap-3 font-semibold text-xs tracking-wider text-[#d8c8b0] uppercase">
          ...
          <button
            ...
            className="w-full py-3 mt-2 rounded-lg font-pirate text-lg text-white font-bold btn-crimson text-center flex items-center justify-center gap-2"
          >
