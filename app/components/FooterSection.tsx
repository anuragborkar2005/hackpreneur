...
export default function FooterSection({ onOpenRegister }: { onOpenRegister: () => void }) {
  return (
    <footer className="w-full min-h-screen flex flex-col justify-center bg-[#1e120d] text-white border-t-2 border-[#d4af37] py-16 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center">
        
        {/* Logo matching reference image */}
        <div className="flex items-center gap-3 mb-4">
          <div className="w-12 h-12 rounded-full bg-gradient-to-br from-amber-700 to-amber-950 p-0.5 shadow-md flex items-center justify-center">
        ...
        <p className="max-w-md text-amber-100/70 font-sans text-sm mb-8">
          The premier 48-hour global cyber-pirate hackathon. Unearth golden code, deploy autonomous swarms, & conquer the digital high seas.
        </p>
        ...
        <div className="w-full max-w-2xl p-8 rounded-2xl bg-[#2b1b17] border border-[#d4af37]/60 mb-12 flex flex-col sm:flex-row items-center justify-between gap-6 shadow-xl">
          ...
          <button
            ...
            className="px-6 py-3 rounded-xl font-pirate text-lg text-white font-bold btn-crimson hover:scale-105 transition-transform shrink-0 shadow-md"
          >
            REGISTER NOW ⚓
          </button>
        </div>
