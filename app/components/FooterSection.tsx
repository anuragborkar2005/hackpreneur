...
const posterSlides: PosterSlide[] = [
    {
        ...
        subtitle:
            "Make AI Agents & RAG Systems | 6th August 2026 | Prize Pool ₹2,000",
    ...
    },
    {
        ...
        subtitle:
            "Prototype & Build Challenge | 7th August 2026 | Prize Pool ₹3,000",
    ...
    },
    {
        ...
        subtitle:
            "High Stakes Battle Royale Tournament | 6th August 2026 | Prize Pool ₹3,000",
    ...
    },
    {
        ...
        subtitle:
            "Ultimate Tech & Trivia Showdown | 7th August 2026 | Prize Pool ₹1,000",
        badge: "TRIVIA BATTLE",
    },
    {
        id: "code-clash",
        ...
        subtitle:
            "Competitive Speed Coding Contest | 6th August 2026 | Prize Pool ₹1,500",
        badge: "SPEED CODING",
    },
    {
        id: "quiz2code",
        ...
        subtitle:
            "Decode Trivia & Build Code Solutions | 6th August 2026 | Prize Pool ₹1,500",
    ...
    },
    {
        ...
        subtitle:
            "Creative Graphic & Poster Design Challenge | 7th August 2026 | Prize Pool ₹1,500",
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center">
                ...
                <div className="flex items-center gap-3 mb-4">
                    ...
                    <div className="flex flex-col text-left">
                        ...
                        <span className="text-[10px] font-mono text-amber-400/80">
                            Itechroots 16.0 • 1’st International Innovation
                            Hackathon
                        </span>
                    </div>
                </div>
                ...
                <div className="w-full max-w-5xl my-6 flex flex-col items-center">
                    <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-amber-500/40 bg-amber-500/10 text-amber-300 font-mono text-xs uppercase tracking-widest mb-3 shadow-md">
                        ...
                        <span>
                            ITECHROOTS 16.0 EVENT POSTERS ({currentSlide + 1}/
                            {posterSlides.length})
                        </span>
                    </div>
                ...
                <div className="w-full max-w-3xl p-6 rounded-2xl bg-[#2b1b17] border border-[#d4af37]/60 mb-8 flex flex-col sm:flex-row items-center justify-between gap-6 shadow-xl text-left">
                    <div>
                        ...
                        <div className="text-xs text-amber-200/80 font-mono mt-1.5 flex flex-wrap items-center gap-3">
                            ...
                            <span>|</span>
                            <span className="inline-flex items-center gap-1">
                                <Gift className="w-4 h-4 text-amber-600" /> ₹5K
                                Capello Vouchers
                            </span>
                        </div>
                        <div className="mt-2 text-xs font-mono text-amber-300/90 flex flex-wrap gap-4">
                            <span className="inline-flex items-center gap-1">
                                ...
                                Tejasvi Jadhao: 9403315952
                            </span>
                            <span className="inline-flex items-center gap-1">
                                <Phone className="w-3.5 h-3.5 text-amber-400" />{" "}
                                Ojas Satdeve: 8856012282
                            </span>
                        </div>
                    </div>
                ...
                <div className="text-[11px] font-mono text-amber-400/50 border-t border-amber-900/40 pt-6 w-full flex flex-col sm:flex-row justify-between items-center gap-4">
                    <span>
                        © 2026 HACKPRENEUR. IT DEPARTMENT, YCCE. ALL RIGHTS
                        RESERVED.
                    </span>
